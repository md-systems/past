...
/**
 * @file
 * Contains Drupal\past_db\Form\PastEventTypeForm.
 */
...
//    }
  ...
  public function submitDelete(array $form, FormStateInterface $form_state) {
    $form_state->setRedirect('past_db.event_type.delete', array('past_event_type' => $this->entity->id()));
  }
